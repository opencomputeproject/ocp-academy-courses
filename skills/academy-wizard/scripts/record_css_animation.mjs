...
if (!htmlPath || !outputPath || !posterPath) {
  throw new Error('usage: record_css_animation.mjs <html> <output.mp4|output.webm> <poster.png> [duration_ms] [poster_ms] [fps]');
}
...
const codecArgs = isMp4
  ? [
      '-vf', 'scale=out_color_matrix=bt709:out_range=tv:flags=bicubic+accurate_rnd',
      '-c:v', 'libx264',
      '-preset', 'slow',
      '-tune', 'animation',
      '-crf', '8',
