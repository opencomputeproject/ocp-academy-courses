...
- A glossary inventory that covers unfamiliar acronyms in visible text and narration. Every `term_ref` resolves to a defined term, and each pill sits on the first substantive slide in that module where the term is actually used.
